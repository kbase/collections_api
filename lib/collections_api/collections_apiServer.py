...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'collections_api'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from collections_api.collections_apiImpl import collections_api  # noqa @IgnorePep8
impl_collections_api = collections_api(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'collections_api'
        ...
        self.rpc_service.add(impl_collections_api.list_collections,
                             name='collections_api.list_collections',
                             types=[])
